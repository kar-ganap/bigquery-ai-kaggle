#!/usr/bin/env python3
"""
Automatic Clean Dataset Refresh - Non-interactive version
Rebuilds entire ads_demo dataset from scratch without user confirmation
"""
import os
import time
...
def auto_clean_dataset_refresh():
    """Perform automatic clean refresh of the ads_demo dataset"""
    
    print("🔥 AUTOMATIC CLEAN DATASET REFRESH")
    print("=" * 50)
    print("This will:")
...
if __name__ == "__main__":
    success = auto_clean_dataset_refresh()
    if success:
        print("\n🎉 AUTOMATIC CLEAN REFRESH COMPLETED SUCCESSFULLY!")
    else:
        print("\n❌ AUTOMATIC CLEAN REFRESH FAILED - Check logs for details")