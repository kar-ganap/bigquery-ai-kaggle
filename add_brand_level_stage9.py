#!/usr/bin/env python3
"""
Add brand-level Stage 9 summary to replace aggregate analysis
"""
...
# Find the Stage 9 summary cell
target_cell = None
for i, cell in enumerate(notebook['cells']):
    if cell['cell_type'] == 'code' and 'source' in cell:
        source_text = ''.join(cell['source'])
        if 'MULTI-DIMENSIONAL INTELLIGENCE - COMPREHENSIVE COMPETITIVE DASHBOARD' in source_text:
            target_cell = i
            break

if target_cell is not None:
    # Create brand-level Stage 9 summary cell
    brand_level_code = '''
...
'''
    ...
    # Insert the new cell after the current Stage 9 summary
    new_cell = {
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
        "outputs": [],
        "source": brand_level_code.strip().split('\n')
    }

    # Add the new cell right after the existing Stage 9 summary
    notebook['cells'].insert(target_cell + 1, new_cell)

    print("✅ Added brand-level Stage 9 intelligence dashboard!")

else:
    print("❌ Could not find Stage 9 summary cell")

# Save the updated notebook
with open(notebook_path, 'w') as f:
    json.dump(notebook, f, indent=1)

print("\n✅ Notebook updated with brand-level Stage 9 analysis!")
print("\n🎯 What was added:")
print("   1. 📊 Brand-level intelligence breakdown (vs meaningless aggregate)")
print("   2. 👥 Individual audience strategy analysis per brand")
print("   3. 🎨 Creative intelligence comparison across competitors")
print("   4. 📡 Channel strategy assessment by brand")
print("   5. 🎯 Strategic positioning analysis per competitor")
print("   6. 💡 Brand-specific insights and recommendations")
print("   7. 📋 Actionable strategic recommendations per brand")
print("   8. 🔥 Differentiation opportunity identification")

print("\n📋 Brand-Level Metrics Structure:")
print("   • Total Ads: Volume and scale per brand")
print("   • Cross-Platform Strategy: Multi-channel approach per brand")
print("   • Text Length: Communication style analysis")
print("   • Price-Conscious Focus: Value vs premium positioning")
print("   • Millennial Targeting: Age demographic focus")
print("   • Creative Density: Style variety and differentiation")
print("   • Platform Diversification: Channel strategy breadth")
print("   • Premium Positioning: Quality vs value messaging")
print("   • Differentiation Signals: Unique value proposition strength")

print("\n✨ Strategic Impact:")
print("   • Enables competitor-specific strategic responses")
print("   • Identifies brand-level whitespace opportunities")
print("   • Provides actionable intelligence vs generic market insights")
print("   • Supports targeted competitive positioning decisions")