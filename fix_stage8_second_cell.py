#!/usr/bin/env python3
"""
Fix the actual Stage 8 Deep Dive CODE cell (not the output cell)
"""
...
# Find the actual CODE cell (not output) with Stage 8 Deep Dive
cell_count = 0
for i, cell in enumerate(notebook['cells']):
    if cell['cell_type'] == 'code' and 'source' in cell:
        ...
        if "=== STAGE 8 DEEP DIVE:" in source_text:
            ...
            # This should be the second (actual code) cell
            if cell_count == 2:
                print(f"Found the actual Stage 8 Deep Dive CODE cell (#{i})...")
...
if 'cta_df' in locals() and not cta_df.empty:
    ...
    print("   Run Stage 8 CTA Analysis first")'''
                ...
                print("✅ Replaced the actual CODE cell with clean syntax!")
                break
...
print("🎯 Fixed the actual Stage 8 Deep Dive CODE cell (not the output cell)")