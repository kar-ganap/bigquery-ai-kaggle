    ...
    if cell['cell_type'] == 'code' and 'source' in cell:
        ...
        if "TEMPORAL INTELLIGENCE WITH CONFIDENCE" in source_text:
            ...
            if split_index > 0:
                ...
                # Create separate cells for each temporal analysis
                new_cells = []
                ...
                new_cells.append(temporal_intro_cell)
                ...
                creative_fatigue_cell = {
                    ...
                    "source": [
                        ...
                        "    import numpy as np\n",
                        "    \n",
                        "    # Simulate creative fatigue data for demonstration\n",
                ...
                new_cells.append(creative_fatigue_cell)
                ...
                new_cells.append(momentum_cell)

                # 4. Competitive Copying Analysis
                copying_cell = {
                    "cell_type": "code",
                    "execution_count": None,
                    "metadata": {},
